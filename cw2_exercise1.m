...
Q_test1(:,:,1) = 100;
Q_test1(:,:,3) = 100;
% obviously this is not a correctly computed Q-function; it does imply a
% policy however: Always go Up! (though on a clear road it will default to 
% the first indexed action: go left)
